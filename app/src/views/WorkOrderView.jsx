...
import { MATERIAL_LABEL, WORK_ORDER_COLOR, WORK_ORDER_LABEL } from '../styles/theme';
import { useRealtime } from '../hooks/useRealtime';

const COLUMNS = Object.entries(WORK_ORDER_LABEL).map(([value, label]) => ({
  status: Number(value),
  label,
  color: WORK_ORDER_COLOR[value]
}));
                    ...
                    <Stack direction="row" spacing={1}>
                      ...
                      <Box sx={{ minWidth: 0, flex: 1 }}>
                        ...
                        <Typography variant="caption" color="text.secondary" component="div">
                          {CasePresenter.workOrderTypeLabel(w.TYPE)} · {w.WORKER_USER ?? '未指派'}
                        </Typography>
                      </Box>
                    </Stack>

...
export const TASK_DEFS = {
  ...
  caseProgress: { label: '案件處理進度統計', cron: '15 * * * *', timeoutMs: 30 * 60_000 }, // 每小時 15 分
 ...
 * 排程名稱由定義推導，不另外手寫一份聯集。
 *
 * 兩份各自維護的話，新增一支排程要改兩個地方 —— 而漏掉型別那一份時，
 * 錯誤訊息會指向「這個鍵不存在」，看起來像是拼錯字。
 */
export type TaskKey = keyof typeof TASK_DEFS;

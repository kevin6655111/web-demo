...
import { MAINTAIN_LEVEL_DEF, keysOf, type MaintainLevel } from '@road-patrol/shared';

export const MAINTAIN_LEVEL = keysOf(MAINTAIN_LEVEL_DEF);
export type { MaintainLevel };

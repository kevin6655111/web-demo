...
import { CRACK_LABEL, DEGREE_COLOR, DEGREE_LABEL, MATERIAL_LABEL } from '../../../config/vocabulary';
              ...
              {workOrder ? (
                <>
                  ...
                  <SpecSheet
                    ...
                    groups={[
                      {
                        title: '派工',
                        fields: [
                          { label: '施工人員', name: 'WORKERS_TEXT', span: 6 },
                          { label: '施工單位', name: 'WORK_UNIT_NAME', span: 6 },
                    ...
                    value={{
                      ...workOrder,
                      MATERIAL_TEXT: MATERIAL_LABEL[workOrder.MATERIAL] ?? workOrder.MATERIAL,
                      // 一張單可以派多人；沒指派時後端回「未指定人員」
                      WORKERS_TEXT: (workOrder.WORKERS ?? []).map((w) => w.NAME).join('、')
                    }}
                  />
